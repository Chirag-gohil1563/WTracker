...
api_key = '75e985e89b2b460b31d1f7aac88ab97c';
...
function getWeatherDetails(name, lat, lon, country, state) {
       ...
       // console.log(data);
        ...
        currentWeatherCard.innerHTML = `<div class="current-weather">
                    ...
                    <div class="card-footer">
                        ...
                        <p><i class="fa-light fa-location-dotr"></i>${name}, ${country}</p>
                    </div>`;
    ...
    .then(data => {
        ...
        let fiveDaysForecast = data.list.filter(forecast => {
            let castDate = new Date(forecast.dt_txt).getDate();
            if (!uniqueForeCastDays.includes(castDate)) {
                uniqueForeCastDays.push(castDate);
                return true;
            }
            return false;
        });
            ...
            fiveDaysForecastCard.innerHTML += `
                <div class="forecast-item">
                    <div class="icon-wrapper">
                        ...
                        <span>${forecast.main.temp.toFixed(1)} &deg;C</span>
                    </div>
...
//         alert('Failed to fetch weather /2forecast')
...
function getUserCoordinates() {
    navigator.geolocation.getCurrentPosition(position => {
        ...
        let REVERSE_GEOCODING_URL = `https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=${api_key}`;
